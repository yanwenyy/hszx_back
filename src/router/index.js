...
const mainRoutes = {
  ...
  children: [
    ...
    {path:'/original-relative-expert-add-or-update', component:_import('modules/original-relative-expert/add-or-update'), name:'original-relative-expert-add-or-update', meta:{title:'相关解读新增or编辑',isTab: true }},
    ...
    {path:'original-/relative-expert-view', component:_import('modules/original-relative-expert/view'), name:'original-relative-expert-view', meta:{title:'相关解读查看',isTab: true }},
    ...
    {path:'/discuss-view', component:_import('modules/discuss/view'), name:'discuss-view', meta:{title:'评论管理查看',isTab: true }},

    //行税之星后台新加
    {path:'/city-list', component:_import('modules/sale/organization/city-list'), name:'city-list', meta:{title:'城市运营中心',isTab: true }},
    {path:'/city-add-or-update', component:_import('modules/sale/organization/city-add-or-update'), name:'city-add-or-update', meta:{title:'城市运营中心新增or编辑',isTab: true }},
    {path:'/city-view', component:_import('modules/sale/organization/city-view'), name:'city-view', meta:{title:'城市运营中心查看',isTab: true }},
    {path:'/shareholder-list', component:_import('modules/sale/organization/shareholder-list'), name:'shareholder-list', meta:{title:'股东机构',isTab: true }},
    {path:'/shareholder-add-or-update', component:_import('modules/sale/organization/shareholder-add-or-update'), name:'shareholder-add-or-update', meta:{title:'股东机构新增or编辑',isTab: true }},
    {path:'/shareholder-view', component:_import('modules/sale/organization/shareholder-view'), name:'shareholder-view', meta:{title:'股东机构查看',isTab: true }},
    {path:'/distributor-list', component:_import('modules/sale/organization/distributor-list'), name:'distributor-list', meta:{title:'经销商机构',isTab: true }},
    {path:'/distributor-add-or-update', component:_import('modules/sale/organization/distributor-add-or-update'), name:'distributor-add-or-update', meta:{title:'经销商机构新增or编辑',isTab: true }},
    {path:'/distributor-view', component:_import('modules/sale/organization/distributor-view'), name:'distributor-view', meta:{title:'经销商机构查看',isTab: true }},
    {path:'/p-shareholder-list', component:_import('modules/sale/personnel/p-shareholder-list'), name:'p-shareholder-list', meta:{title:'股东人员管理',isTab: true }},
    {path:'/p-shareholder-add-or-update', component:_import('modules/sale/personnel/p-shareholder-add-or-update'), name:'p-shareholder-add-or-update', meta:{title:'股东人员新增or编辑',isTab: true }},
    {path:'/p-shareholder-view', component:_import('modules/sale/personnel/p-shareholder-view'), name:'p-shareholder-view', meta:{title:'股东人员查看',isTab: true }},
    {path:'/p-distributor-list', component:_import('modules/sale/personnel/p-distributor-list'), name:'p-distributor-list', meta:{title:'经销商人员管理',isTab: true }},
    {path:'/p-distributor-add-or-update', component:_import('modules/sale/personnel/p-distributor-add-or-update'), name:'p-distributor-add-or-update', meta:{title:'经销商新增or编辑',isTab: true }},
    {path:'/p-distributor-view', component:_import('modules/sale/personnel/p-distributor-view'), name:'p-distributor-view', meta:{title:'经销商查看',isTab: true }},
    {path:'/centerSale-list', component:_import('modules/sale/personnel/centerSale-list'), name:'centerSale-list', meta:{title:'中心销售管理',isTab: true }},
    {path:'/centerSale-add-or-update', component:_import('modules/sale/personnel/centerSale-add-or-update'), name:'centerSale-add-or-update', meta:{title:'中心销售新增or编辑',isTab: true }},
    {path:'/centerSale-view', component:_import('modules/sale/personnel/centerSale-view'), name:'centerSale-view', meta:{title:'中心销售查看',isTab: true }},
    {path:'/shareModel', component:_import('modules/sale/shareSales/shareModel'), name:'shareModel', meta:{title:'分成模板设置',isTab: true }},
    {path:'/shareholder-share', component:_import('modules/sale/shareSales/shareholder-share'), name:'shareholder-share', meta:{title:'股东分成设置',isTab: true }},
    {path:'/centerSale-share', component:_import('modules/sale/shareSales/centerSale-share'), name:'centerSale-share', meta:{title:'销售分成设置',isTab: true }},
    {path:'/card-add-or-update', component:_import('modules/user/card-add-or-update'), name:'card-add-or-update', meta:{title:'万能卡新增or编辑',isTab: true }},
    {path:'/card-view', component:_import('modules/user/card-view'), name:'card-view', meta:{title:'万能卡查看',isTab: true }},
    {path:'/card-member-manage', component:_import('modules/user/card-member-manage'), name:'card-member-manage', meta:{title:'万能卡人员管理',isTab: true }},
    {path:'/card-member-list', component:_import('modules/user/card-member-list'), name:'card-member-list', meta:{title:'万能卡人员列表',isTab: true }},
    {path:'/goodsCard-add-or-update', component:_import('modules/goods/goodsCard-add-or-update'), name:'goodsCard-add-or-update', meta:{title:'卡种新增or编辑',isTab: true }},
    {path:'/goodsCard-view', component:_import('modules/goods/goodsCard-view'), name:'goodsCard-view', meta:{title:'卡种查看',isTab: true }},
    {path:'/vipGoods-add-or-update', component:_import('modules/goods/vipGoods-add-or-update'), name:'vipGoods-add-or-update', meta:{title:'会员商品新增or编辑',isTab: true }},
    {path:'/vipGoods-view', component:_import('modules/goods/vipGoods-view'), name:'vipGoods-view', meta:{title:'会员商品查看',isTab: true }},
    {path:'/vipGoods-batch-add', component:_import('modules/goods/vipGoods-batch-add'), name:'vipGoods-batch-add', meta:{title:'会员商品批量新增',isTab: true }},
  ],
