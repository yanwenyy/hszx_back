  ...
  <div class="mod-policy">
    ...
    <el-form label-position="left" label-width="120px" :model="dataForm" :rules="dataRule" ref="dataForm">
      ...
      <el-form-item label="内容" prop="content">
        <template>
          <UEditor :key="'editor_imputation'" :url="'/biz/trpolicy/updateAndAuditInfo/'" :val="dataForm.id" :id='"editor_imputation"':index="0" :econtent="dataForm.content" :modelname="'imputation'" @func="editorContent" ></UEditor>
        </template>
      </el-form-item>
