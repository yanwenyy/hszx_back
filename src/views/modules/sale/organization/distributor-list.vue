<template>
  <div class="mod-policy">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-button type="warning" v-if="isAuth('biz:trpolicyoriginal:save')" @click="$router.push({ name: 'distributor-add-or-update'})">新增</el-button>
      </el-form-item>
      <el-form-item>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" v-if="isAuth('biz:trpolicyoriginal:update')"  @click="$router.push({ name: 'distributor-add-or-update',query:{id:scope.row.id} })">编辑</el-button>
          <el-button type="text" size="small" v-if="isAuth('biz:trpolicyoriginal:info')" @click="$router.push({ name: 'distributor-view',query:{id:scope.row.id} })">查看</el-button>
...
<script>
  ...
  export default {
    ...
    mounted(){
      //股东机构列表
      this.$http({
        url: this.$http.adornUrl('/biz/organization/agentListOfNoPaging'),
        method: 'GET',
      }).then(({data}) => {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/biz/organization/agentListOfPaging'),
          method: 'get',
          params: this.$http.adornParams({
            ...
            'pType':this.dataForm.pType|| undefined,
            'pid':this.dataForm.pid|| undefined,
            'ppid':this.dataForm.ppid|| undefined,
