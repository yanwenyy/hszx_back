<template>
  <div class="mod-policy">
    ...
    <el-form label-position="left" label-width="120px" :model="dataForm" ref="dataForm">
      ...
      <el-form-item prop="platformAuthorName" label="作者">
        <el-input v-model="dataForm.platformAuthorName" disabled  style="width:500px"></el-input>
      </el-form-item>
      <el-form-item label="行业" prop="tradeName">
        <el-input v-model="dataForm.tradeName" disabled  style="width:500px"></el-input>
      </el-form-item>
      <el-form-item label="属性" prop="attributeName">
        <el-input v-model="dataForm.attributeName" disabled  style="width:500px"></el-input>
      </el-form-item>
